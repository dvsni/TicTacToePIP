...
def make_move(screen, symbol):
    for i in range(3):
        for j in range(3):
            if symbol[i][j] == "0":
                pygame.draw.circle(screen, (255, 255, 0), (j * 100 + 50, i * 100 + 50), 45)
            elif symbol[i][j] == "x":
                pygame.draw.line(screen, (255, 0, 255), (j * 100 + 5, i * 100 + 5), (j * 100 + 95, i * 100 + 95), 20)
                pygame.draw.line(screen, (255, 0, 255), (j * 100 + 95, i * 100 + 5), (j * 100 + 5, i * 100 + 95), 20)
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and not game_over:
            ...
            if player_1 or player_2:
                game_over = True
                if player_1:
                    pygame.display.set_caption("Cross win")
                else:
                    pygame.display.set_caption("Zero win")
